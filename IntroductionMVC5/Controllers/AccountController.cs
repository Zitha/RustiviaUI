        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    ...
                    //if (user.Roles.Where(r => r.RoleId == "RustiviaKey").FirstOrDefault() != null
                    //    || user.Roles.Where(r => r.RoleId == "AdminKey").FirstOrDefault() != null)
                    //{
                    return RedirectToAction("Index", "Home");
                    //}
                    //if (user.Roles.Where(r => r.RoleId == "ArlsoKey").FirstOrDefault() != null)
                    //{
                    //    return RedirectToAction("Index", "Arslo");
                    //}
                }
